import { buildContextSummary } from "../firestoreService.js"
import { SYSTEM_PROMPT_GUARD } from "./promptGuard.js"
...
Return JSON in exactly this format:
{
  ...
  "evidenceToCollect": ["string (specific evidence item the user should gather right now)"],
...
Return JSON in exactly this format:
{
  ...
  "approaching": ["string (name of any deadline within 7 days)"],
